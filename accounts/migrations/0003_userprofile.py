...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0002_rename_frist_name_user_first_name'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lettitude', models.CharField(blank=True, max_length=20, null=True)),
                ('longitudev', models.CharField(blank=True, max_length=20, null=True)),
